...
capsicum_gApple = images(1: 16);
% Orange and red apple
orange_rApple = images(25: 40);
% green apple and orange
gApple_orange = images([9: 16, 25:32]);

%% Superimpose capsicum and green apple
...
for i=1:8
    ...
    for k=1:nfiles_bg
        ...
        for j = 1: 4
            ...
            %% Second fruit
            start_x_point = grid_point(5-j, 1) + offset;
            start_y_point = grid_point(5-j, 2) + offset;
...
%% Superimpose orange and red apple
images = orange_rApple;
for i=1:8
...
%% Superimpose green apple and orange
images = gApple_orange;
for i=1:8
